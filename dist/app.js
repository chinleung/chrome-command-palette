  ...
  setup: function setup(__props, _ref) {
    ...
    var filteredItems = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function (_) {
      ...
      return items.value.map(function (item) {
        ...
        var _item$label, _item$label$toLowerCa, _item$url, _item$url$toLowerCase, _item$description, _item$description$toL;

        return ((_item$label = item.label) === null || _item$label === void 0 ? void 0 : (_item$label$toLowerCa = _item$label.toLowerCase()) === null || _item$label$toLowerCa === void 0 ? void 0 : _item$label$toLowerCa.includes(search)) || ((_item$url = item.url) === null || _item$url === void 0 ? void 0 : (_item$url$toLowerCase = _item$url.toLowerCase()) === null || _item$url$toLowerCase === void 0 ? void 0 : _item$url$toLowerCase.includes(search)) || ((_item$description = item.description) === null || _item$description === void 0 ? void 0 : (_item$description$toL = _item$description.toLowerCase()) === null || _item$description$toL === void 0 ? void 0 : _item$description$toL.includes(search));
      });
    });
